      ...
      <section className="relative h-[80vh] w-full flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 items-center z-10">
          <motion.div 
            ...
            className="space-y-6 bg-black/40 p-8 rounded-3xl backdrop-blur-sm"
          >
            <h1 className="text-5xl md:text-7xl font-serif font-bold text-white leading-tight uppercase tracking-tighter">
              STYLED IN OUR<br />
              <span className="text-primary italic">TEAR DROP EARRING</span>
            </h1>
            <div className="flex gap-4">
              <Link href="/shop">
                <Button size="lg" className="rounded-full px-8 hover-elevate bg-white text-black hover:bg-white/90">
